...
class GroupUtils:
    ...
    def send_email(content):
        GroupUtils.the_email(content, 'liuxiongbing@sanniuben.com')
        GroupUtils.the_email(content, 'zhongsheng@sanniuben.com')
        GroupUtils.the_email(content, 'myp@sanniuben.com')
